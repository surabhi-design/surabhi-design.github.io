...
`,I=e=>{let{color:t,rotation:a,textColor:o,marginLeft:r,marginRight:l,children:d}=e;const[p,m]=Object(i.useState)({x:0,y:0});return n.a.createElement(N,{color:t,rotation:a,textColor:o,marginLeft:r,marginRight:l,offsetX:p.x,offsetY:p.y,onMouseMove:e=>{const{left:t,top:a,width:i,height:n}=e.target.getBoundingClientRect(),o=e.clientX-(t+i/2),r=e.clientY-(a+n/2);m({x:o/10,y:r/10})},onMouseLeave:()=>{m({x:0,y:0})}},d)},N=p.a.a`
